...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;5ww;600;700&display=swap"
        rel="stylesheet" />
...
<body>
    ...
    <nav class="navbar">
        <div class="container">
            ...
            <div class="nav-left">
                ...
                <div class="main-nav left-nav">
                    ...
                    <a class="nav-link admin-link" href="admin.php"
                        title="Admin Panel - <?php echo htmlspecialchars($userName); ?>"><svg class="icon"
                            viewBox="0 0 24 24" width="16" height="16" xmlns="http://www.w3.org/2000/svg"
                            aria-hidden="true">
                            <path
                    ...
                    <?php endif; ?>
                    <a class="nav-link" href="#about"><svg class="icon" viewBox="0 0 24 24" width="16" height="16"
                            xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            <path d="M12 12a5 5 0 1 0 0-10 5 5 0 0 0 0 10zm0 2c-4 0-7 2-7 4v2h14v-2c0-2-3-4-7-4z"
                                fill="currentColor" />
                        </svg>Tentang</a>
                    <a class="nav-link" href="#products"><svg class="icon" viewBox="0 0 24 24" width="16" height="16"
                            xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            <path d="M3 7h18v2H3zM3 11h18v2H3zM3 15h12v2H3z" fill="currentColor" />
                        </svg>Produk</a>
                </div>
            </div>
            ...
            <a class="navbar-brand center-brand" href="#">
                <img src="img/PADI%20MART.png" alt="PADI MART logo" class="brand-logo" />
            </a>

            <!-- Right side: right nav links -->
            <div class="nav-right">
                <div class="main-nav right-nav">
                    <a class="nav-link" href="#testimonials"><svg class="icon" viewBox="0 0 24 24" width="16"
                            height="16" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"
                                fill="currentColor" />
                        </svg>Testimoni</a>
                    <a class="nav-link" href="#contact"><svg class="icon" viewBox="0 0 24 24" width="16" height="16"
                            xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                            <path d="M21 8V7l-3 2-2-1-6 6 1 2 2-1 6-6 1 2 3-2zM3 21h18v-2H3v2z" fill="currentColor" />
                        </svg>Kontak</a>
                </div>

                <div class="toggle-cont">
                    <input class="toggle-input" id="themeToggle" name="themeToggle" type="checkbox" />
                    <label class="toggle-label" for="themeToggle">
                        <div class="cont-icon">
                            ...
                            <div class="cloud-elements">
                                <svg class="cloud cloud1" viewBox="0 0 24 24" width="20" height="20"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill="currentColor"
                                        d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96z" />
                                </svg>
                                <svg class="cloud cloud2" viewBox="0 0 24 24" width="16" height="16"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill="currentColor"
                                        d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96z" />
                                </svg>
                                <svg class="cloud cloud3" viewBox="0 0 24 24" width="18" height="18"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill="currentColor"
                                        d="M19.35 10.04C18.67 6.59 15.64 4 12 4 9.11 4 6.6 5.64 5.35 8.04 2.34 8.36 0 10.91 0 14c0 3.31 2.69 6 6 6h13c2.76 0 5-2.24 5-5 0-2.64-2.05-4.78-4.65-4.96z" />
                                </svg>
                            ...
                            <div class="star-elements">
                                <svg class="star star1" viewBox="0 0 24 24" width="12" height="12"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill="currentColor"
                                        d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                                </svg>
                                <svg class="star star2" viewBox="0 0 24 24" width="10" height="10"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill="currentColor"
                                        d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                                </svg>
                                <svg class="star star3" viewBox="0 0 24 24" width="14" height="14"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill="currentColor"
                                        d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                                </svg>
                                <svg class="star star4" viewBox="0 0 24 24" width="8" height="8"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill="currentColor"
                                        d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                                </svg>
                                <svg class="star star5" viewBox="0 0 24 24" width="11" height="11"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path fill="currentColor"
                                        d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" />
                                </svg>
                            ...
                            <svg class="knob-sun" viewBox="0 0 24 24" width="14" height="14"
                                xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                <path fill="currentColor"
                            ...
                            <svg class="knob-moon" viewBox="0 0 24 24" width="14" height="14"
                                xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
    ...
    <div class="side-menu" id="sideMenu" aria-hidden="true">
        ...
        <div class="side-menu-content">
            ...
            <div class="user-dropdown-container side-menu-user-container">
                <button class="user-dropdown-btn side-menu-user-btn" id="sideMenuUserDropdownBtn"
                ...
                <div class="user-dropdown-menu side-menu-user-dropdown" id="sideMenuUserDropdownMenu">
                    <?php if ($isLoggedIn): ?>
                    <!-- Logged in user -->
                    <div class="dropdown-header">
                        <div class="dropdown-user-info">
    ...
    <section id="about" class="section container">
        <div class="about-grid">
            <div class="about-text">
                ...
                <p>
                    PADI MART (Pemasaran Digital untuk Produk Turunan Pertanian) adalah program pengembangan usaha
                    berbasis teknologi yang bertujuan untuk meningkatkan nilai tambah dan daya jual produk turunan hasil
                    pertanian.
                    Melalui program ini, para petani, pelaku UMKM, dan kelompok perempuan tani diberikan pendampingan
                    dalam hal pengolahan produk, branding, serta strategi pemasaran digital agar mampu bersaing di pasar
                    modern.
                </p>
                <br>
                <p>
                    Program ini tidak hanya fokus pada peningkatan keterampilan produksi, tetapi juga membuka akses
                    pemasaran yang lebih luas melalui platform digital seperti marketplace, media sosial, dan katalog
                    online.
                    Dengan memanfaatkan teknologi, PADI MART membantu pelaku usaha meningkatkan kualitas kemasan,
                    membangun identitas brand, serta mempromosikan produk unggulan pertanian secara profesional.
                </p>
                <br>
                <p>
                    Melalui kegiatan pelatihan, pendampingan, dan praktik langsung,
                    PADI MART berkomitmen mendorong kemandirian ekonomi lokal, memperluas pasar, dan meningkatkan
            ...
            <div class="about-video">
                ...
                <div class="video-wrapper">
                    <iframe id="profileVideo" src="https://www.youtube.com/embed/MTqNC1MBX2Y" title="PADI MART Profile"
                        frameborder="0"
    ...
    <section id="products" class="section container">
        ...
        <div class="product-controls">
            <input id="searchInput" type="search" placeholder="Cari produk, misal: beras, camilan" />
            ...
            <article class="testimonial" role="listitem">
                <div class="testimonial-header">
                    <div class="testimonial-avatar"
                        style="background: linear-gradient(135deg, #58c234 0%, #58b530 100%);"
                        aria-label="Avatar Siti Nurhaliza">
                ...
                <blockquote class="testimonial-text">
                    <p>"Beras tersebut rasanya nyaman, pulen tetapi pulennya beda dengan beras pulen biasanya, tidak
                        terlalu pulen jadi sangat cocok dengan lidah saya"</p>
                </blockquote>
            </article>
        </div>
    </section>
            ...
            <div class="footer-content">
                <div class="footer-grid">
                    ...
                    <div class="footer-section footer-brand">
                        ...
                        <p class="footer-description">
                            Platform digital untuk memperkenalkan dan memasarkan produk lokal berkualitas dari petani
                            dan pelaku usaha agribisnis.
                        </p>
                        <div class="footer-social">
                            <a href="https://wa.me/628123456789" target="_blank" rel="noopener" aria-label="WhatsApp"
                                class="social-link">
                    ...
                    <div class="footer-section">
                        ...
                        <ul class="footer-info">
                            ...
                            <li>
                                ...
                                <a href="tel:+628123456789">+62 823-5736-0603 Afrida <br> +62 896-4770-9998 Yati</a>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="footer-bottom">
                    ...
                    <div class="footer-bottom-content">
                        <p class="copyright">
                            © 2025 PADI MART. Semua hak dilindungi. Platform digital untuk petani dan pelaku usaha
                            lokal.
                        </p>
                ...
                <div class="modal-info-section">
                    ...
                    <div class="modal-details">
                        ...
                        <div class="detail-grid">
                            ...
                            <div class="detail-item">
                                ...
                                <span class="detail-value" id="modalOrigin">Tabalong, Kalimantan Selatan</span>
                            </div>
                            <div class="detail-item">
                    ...
                    <div class="modal-actions">
                        <button class="btn-whatsapp" id="modalWhatsappBtn">
                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                <path d="M21 15a4 4 0 0 1-4 4H7l-4 4V5a2 2 0 0 1 2-2h14a4 4 0 0 1 4 4z"></path>
                            </svg>
                            Chat via WhatsApp
                        </button>
    ...
    <a id="whatsappBtn" class="uiverse-whatsapp" href="https://wa.me/+6289647709998" target="_blank" rel="noopener"
        aria-label="Chat via WhatsApp">
        <div class="Btn" role="button" aria-hidden="false">
            <div class="sign">
                <svg class="socialSvg whatsappSvg" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"
                    aria-hidden="true">
                    <path
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const sideMenuDropdownBtn = document.getElementById('sideMenuUserDropdownBtn');
        const sideMenuDropdownMenu = document.getElementById('sideMenuUserDropdownMenu');
        ...
        if (sideMenuDropdownBtn && sideMenuDropdownMenu) {
            sideMenuDropdownBtn.addEventListener('click', function(e) {
                e.stopPropagation();
                sideMenuDropdownMenu.classList.toggle('show');
            });

            // Close when clicking outside
            document.addEventListener('click', function(e) {
                if (!sideMenuDropdownMenu.contains(e.target) && !sideMenuDropdownBtn.contains(e
                        .target)) {
                    sideMenuDropdownMenu.classList.remove('show');
                }
            });

            // Close when clicking a link inside
            sideMenuDropdownMenu.querySelectorAll('.dropdown-item').forEach(item => {
                item.addEventListener('click', function() {
                    setTimeout(() => {
                        sideMenuDropdownMenu.classList.remove('show');
                    }, 100);
